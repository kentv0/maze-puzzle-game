...
/**
 * The MazeGrid Class is the GUI for {@link MazeSolver.class}.
 *
    ...
    private void addComponents(JPanel panel) {
        ...
        for(int i = 0; i < DIMENSION; i++) {
            for(int j = 0; j < DIMENSION; j++) {
                ...
                gridLabels[i][j].setFont(new Font(Font.SANS_SERIF,
                                                  Font.BOLD, 8));
...
////////////////////////////////////////////////////////////////////////
    ...
    // within the grid, and the background is not black. Does NOT detect if the
    // move is legal since it does not maintain history. A move such as to a
    // diagonal cell, or a move greater than 1 cell away may be valid if the
    // cell is within the grid, and does not have a black background. However,
    // such moves are illegal. This method does **NOT** detect illegal moves,
    // only invalid ones.
    ...
    // Sets the background color of the cell to indicate that it is in the
    // shortest path.
    ...
    // Sets the distance in the given GridCell instance, and displays that
    ...
    private void printFailureMessage() {
        JOptionPane.showMessageDialog(this,
        "Sorry, this maze has no solution!!");
    }
}
